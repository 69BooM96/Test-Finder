...
class Load_data:
	list_object = ['/cat/biologiya/', '/cat/geografiya/', '/cat/himiya/', '/cat/istoriya-ukrayini/', '/cat/pravoznavstvo/', '/cat/ekonomika/', 
...
def main():
	pomahach = Load_data()
	listik = pomahach.search('/cat/biologiya/', storinka=(1,11))
